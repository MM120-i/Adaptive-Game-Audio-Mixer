...
int readBoundedInt (const juce::DynamicObject& object,
...
juce::String readString (const juce::DynamicObject& object,
                         const juce::Identifier& key,
...
AppSettings AppSettings::fromJson (const juce::var& json, bool& usedDefaults) {
    ...
    settings.windowWidth = readBoundedInt (*object,
                                           "windowWidth",
                                           settings.windowWidth,
                                           minimumWindowWidth,
                                           maximumWindowWidth,
                                           usedDefaults);
    settings.windowHeight = readBoundedInt (*object,
                                            "windowHeight",
                                            settings.windowHeight,
                                            minimumWindowHeight,
                                            maximumWindowHeight,
                                            usedDefaults);
    settings.verboseDiagnostics = readBool (*object,
                                            "verboseDiagnostics",
                                            settings.verboseDiagnostics,
                                            usedDefaults);
    settings.lastLaunchTimestamp = readString (*object,
                                               "lastLaunchTimestamp",
